...
export default function EditProfileScreen({ navigation }: any) {
  ...
  const { phoneError, passwordChecklist, passwordValid, confirmPasswordError } = useFormValidation(nombre, correo, telefono, contraseña, confirmPassword);
    ...
    <KeyboardAvoidingView style={styles.container} behavior={Platform.OS === 'ios' ? 'padding' : 'height'}>
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        ...
        <View style={styles.form}>
          ...
          <TextInput style={[styles.input, styles.disabledInput]} placeholder="tu@email.com" placeholderTextColor="#999" value={correo} editable={false} />
          ...
          <TextInput
            ...
            autoCapitalize="none"
          />
          {contraseña && !originalContraseña && <Text style={styles.warningText}>⚠️ Debes ingresar tu contraseña actual para cambiarla</Text>}
          ...
          {/* Botón Guardar */}
          <TouchableOpacity style={[styles.updateButton, (!isFormValid() || saving) && styles.updateButtonDisabled]} onPress={handleUpdate} disabled={!isFormValid() || saving}>
            <Text style={styles.updateButtonText}>{saving ? 'Guardando...' : 'Guardar Cambios'}</Text>
          </TouchableOpacity>
