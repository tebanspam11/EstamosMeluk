...
export default function ProfileScreen({ navigation }: any) {
  ...
  const handleEliminarCuenta = () => {
    Alert.alert('⚠️ Eliminar cuenta', 'Esta acción es irreversible. Se eliminarán todos tus datos, mascotas, eventos y documentos. ¿Estás completamente seguro?', [
      {
        text: 'Cancelar',
        style: 'cancel',
      },
    ...
    <SafeAreaView style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.avatarSection}>
          <TouchableOpacity style={styles.avatarContainer} onPress={handleChangePhoto} disabled={uploadingPhoto}>
            {usuario?.foto ? (
        ...
        <Text style={styles.warningText}>La eliminación de cuenta es permanente e irreversible</Text>
      </ScrollView>
    </SafeAreaView>
  );
}
