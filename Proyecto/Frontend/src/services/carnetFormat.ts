export default function carnetFormat(
  ...
  desparasitaciones: any[]
    ...
    const carnetFormat = `
        ...
        <body>
          ...
          ${vacunas.length === 0 ? '<p style="text-align: center; color: #666; font-style: italic;">No hay vacunas registradas</p>' : `
              <table>
                <thead>
                  <tr>
                    <th>Aplicación</th>
          ...
          ${desparasitaciones.length === 0 ? '<p style="text-align: center; color: #666; font-style: italic;">No hay desparasitaciones registradas</p>' : `
              <table>
                <thead>
                  <tr>
                    <th>Aplicación</th>
